...
<div id="citas-admin">
    ...
    $message = urlencode("$saludo $client_name, te saluda $business_name Tabacundo. Te recordamos que tienes una cita el día $appointment_date a las $appointment_time. Por favor, responde a este mensaje confirmando tu asistencia. ¡Te esperamos!");
